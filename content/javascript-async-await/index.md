...
[JavaScript](https://flaviocopes.com/javascript/) evolved in a very short time from callbacks to [promises](https://flaviocopes.com/javascript-promises/) (ES2015), and since [ES2017](https://flaviocopes.com/ecmascript/#es2017-aka-es8) asynchronous JavaScript is even simpler with the async/await syntax.

Async functions are a combination of promises and [generators](https://flaviocopes.com/ecmascript/#generators), and basically, they are a higher level abstraction over promises. Let me repeat: **async/await is built on promises**.
